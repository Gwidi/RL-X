# Proximal Policy Optimization + History Window

Contains the implementation of [Proximal Policy Optimization (PPO)](https://arxiv.org/abs/1707.06347) in combination with a history window for the policy network.
