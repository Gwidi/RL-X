...
def get_config(environment_name):
    config = {
        ...
        "env_curriculum_level_failure_episode_return": 8.0,
        "env_curriculum_start_zone_radius_m": 0.8,
        "env_curriculum_min_outside_start_zone_fraction": 0.0,
        ...
        "terrain": {
            "type": "hfield_diverse",
            "uses_calf_colliders": False,
            "uses_thigh_colliders": False,
            "wave_fn_min": 0,
            "wave_fn_max": 2,
            ...
            # lowest, flat spawn platform and each box ring is one step.
            "inverted_pyramid_half_width_m": 4.0,
