...
class HFieldHurdlesTerrainGeneration(
    ...
    def get_debug_overlay(self):
        ...
        return [
            ...
            (
                "First wall",
                f"{self.first_wall_distance_m:.3f} m",
            ),
            ("Wall spacing", f"{self.wall_spacing_m:.3f} m"),
            (
                "Requested thickness",
                f"{self.wall_thickness_m:.3f} m",
            ),
            (
                "Flat-top thickness",
                f"{self.effective_wall_thickness_m:.3f} m",
            ),
            ("Wall height", f"{applied_height_m:.3f} m"),
        ]
